...
golem::fill_desc(
  ...
  author_email = "dwightkschrute@stoltzmanconstuling.com", # Your Email
  repo_url = "hhttps://github.com/Stoltzman-Consulting/theoffice.git" # The URL of the GitHub Repo (optional)
  )
